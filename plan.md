...
- [ ] 创建 AI 配置管理（API Key、模型选择）
- [ ] 实现后端 AI 代理路由（/api/ai/chat）
- [ ] 实现流式响应处理（SSE）
- [ ] 创建前端 AI API 客户端
- [ ] 实现错误处理和重试机制
- [ ] 编写 Chapter 20 教程文档
...
**状态：** 待开始  
**Commit：** `feat: 实现 AI 快捷指令（续写、改写、扩写、总结、翻译）`  
**预计时间：** 4-5 小时
